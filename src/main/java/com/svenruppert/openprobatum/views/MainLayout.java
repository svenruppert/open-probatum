...
import com.svenruppert.openprobatum.views.ui.ThemeSwitcher;
...
public class MainLayout extends AppLayout
  ...
  private static final String K_NAV_CATALOG = "nav.catalog";
  ...
  private static final String K_NAV_COACHING_AUTHOR = "nav.coachingauthor";
  ...
  private static final String K_NAV_COACHING = "nav.coaching";
  ...
  private static Button buildAuthActionButton() {
    ...
    if (loggedIn) {
      Button signOut = new Button(
          com.svenruppert.openprobatum.i18n.I18n.tr(K_SIGN_OUT, "Sign out"),
          VaadinIcon.SIGN_OUT.create(), e -> logout());
      signOut.addThemeVariants(ButtonVariant.LUMO_TERTIARY, ButtonVariant.LUMO_SMALL);
      return signOut;
    }
    Button signIn = new Button(
        com.svenruppert.openprobatum.i18n.I18n.tr(K_SIGN_IN, "Sign in"),
