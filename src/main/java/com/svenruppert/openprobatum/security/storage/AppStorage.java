...
public final class AppStorage {
  ...
  public static final class AppRoot {
    ...
    public final Map<String, com.svenruppert.openprobatum.access.Entitlement> entitlements =
        new ConcurrentHashMap<>();
    public final Map<String, com.svenruppert.openprobatum.progress.LearnerProgress> progress =
        new ConcurrentHashMap<>();
    public final Map<UUID, com.svenruppert.openprobatum.assessment.Assessment> assessments =
        new ConcurrentHashMap<>();
    public final Map<UUID, com.svenruppert.openprobatum.assessment.Attempt> attempts =
        new ConcurrentHashMap<>();
    public final Map<UUID, com.svenruppert.openprobatum.assessment.Question> questions =
        new ConcurrentHashMap<>();
    ...
    public final Map<UUID, com.svenruppert.openprobatum.workshop.Workshop> workshops =
        new ConcurrentHashMap<>();
    public final Map<UUID, com.svenruppert.openprobatum.workshop.WorkshopEnrolment> workshopEnrolments =
        new ConcurrentHashMap<>();
    public final Map<UUID, com.svenruppert.openprobatum.coaching.CoachingOffer> coachingOffers =
        new ConcurrentHashMap<>();
    public final Map<UUID, com.svenruppert.openprobatum.coaching.CoachingSlot> coachingSlots =
        new ConcurrentHashMap<>();
  }
}
