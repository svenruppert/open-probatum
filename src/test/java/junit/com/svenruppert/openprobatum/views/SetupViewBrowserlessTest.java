...
class SetupViewBrowserlessTest extends BrowserlessTest {
  ...
  void forwardsToLoginWhenBootstrapDone() {
    navigate("setup", com.svenruppert.openprobatum.views.AppLoginView.class);
  }
  ...
  void emptyTokenWarns() throws Exception {
    ...
    assertEquals(0, com.svenruppert.openprobatum.security.model.UserDirectoryProvider.directory()
        .all().count(),
