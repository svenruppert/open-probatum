...
- Einzelmodul `open-probatum`. V00.10.00 (Trust Core), V00.20.00
  ...
  sind finalisiert + als `v00.10.00` / `v00.20.00` / `v00.30.00` getaggt;
  aktuelle Entwicklungslinie **`00.40.00-SNAPSHOT`** (V00.40.00 — Labs &
  Practical Evidence, Window in P000 geöffnet). `00.40.00` wird beim
  Release-Close finalisiert + als `v00.40.00` getaggt.
